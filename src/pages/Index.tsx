  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      >
        ...
        <div className="w-full max-w-md lg:max-w-lg xl:max-w-xl 2xl:max-w-2xl mx-auto space-y-4 relative z-10 px-4">
          {/* Header */}
          <div className="text-center space-y-1 mb-6">
            <h1 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl text-white tracking-wider font-bold whitespace-nowrap">
              JOIN THE WAITLIST
            </h1>
            ...
            {showEmailInput && (
              <div className="bg-white/5 backdrop-blur-sm rounded-xl border border-white/10 p-4 space-y-3">
                <Input
                  ...
                  className="bg-white/10 border-white/20 text-white placeholder:text-white/60 h-10 rounded-lg"
                />
                <Button
                  onClick={handleEmailSubmit}
                  className="w-full bg-purple-600 hover:bg-purple-700 text-white h-10 rounded-lg font-bold text-sm"
                >
                  Submit Email
                </Button>
              </div>
          ...
          <div className="pt-6">
            <Button
              ...
              className={`w-full h-12 rounded-xl text-base font-bold tracking-wider transition-all duration-300 ${
                allTasksCompleted

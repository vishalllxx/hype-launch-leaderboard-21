        ...
        <div className="grid md:grid-cols-3 gap-12">
          ...
          <div>
            ...
            <form onSubmit={handleSubmit} className="flex gap-3">
              <Input
                ...
                className="bg-white/10 border-white/20 text-white placeholder:text-white/60 h-12 rounded-xl flex-1"
              />
              <Button
                type="submit"
                className="bg-cyan-500 hover:bg-cyan-600 text-white h-12 px-6 rounded-xl font-bold"
              >
                SUBMIT
              </Button>
            </form>
          ...
          <div>
            ...
            <div className="space-y-3">
              <a
                href="https://twitter.com/neftitxyz"
                target="_blank"
